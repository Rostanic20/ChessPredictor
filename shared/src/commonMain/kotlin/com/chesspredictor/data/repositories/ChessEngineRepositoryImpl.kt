...
class ChessEngineRepositoryImpl(
    ...
    override suspend fun analyzeWithEvaluation(
        ...
        val evaluation = EngineEvaluation(
            score = analysis.evaluation.toDouble(), // Already converted to pawns
            mate = analysis.mate,
        ...
        return EngineAnalysis(
            ...
            depth = analysis.depth, // Use actual search depth, not requested
    ...
    // TODO: Implement proper move parsing from engine perft output
    // Currently returns empty list - moves are generated by ChessRulesEngine instead
    override suspend fun getAvailableMoves(board: ChessBoard): List<ChessMove> {
        return emptyList()
    }

    // TODO: Implement real-time evaluation streaming from engine
    // Currently returns neutral evaluation - analysis uses analyzePosition() instead
